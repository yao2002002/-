<template>
	<div class="diy_list page_vehicle_information" id="vehicle_information_list">
		<div class="warp">
			<div class="container diy_list_container">
					...
					<div class="col">
						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																																												<b-form-input size="sm" class="mr-sm-2" placeholder="车辆名称搜索" v-model="query['vehicle_name']" />
																																														<b-form-input size="sm" class="mr-sm-2" placeholder="车辆型号搜索" v-model="query['vehicle_model']" />
				...
				<div class="row diy_list_box">
					<div class="col">
						<!-- 列表 -->
												<list_vehicle_information :list="list" />
												<!-- /列表 -->
					</div>
				</div>
	</div>
...
<script>
	...
	export default {
      ...
      get_list_before(param) {
			 ...
			 */
			reset() {
								this.query.vehicle_name = ""
										this.query.vehicle_model = ""
													this.search();
			},
