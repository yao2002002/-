				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_vehicle_information v-if="$check_action('/vehicle_information/table','get')"></table_vehicle_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_vehicle_information from "../../components/diy/table_vehicle_information.vue";
	export default {
		data() {
			return {
			};
