<template>
	<div class="diy_details page_vehicle_information" id="vehicle_information_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_vehicle_information'>
							<div_vehicle_information :obj="obj"></div_vehicle_information>
...
<script>
	import div_vehicle_information from "@/components/diy/div_vehicle_information.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/vehicle_information/set?vehicle_information_id=' + obj["vehicle_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			async get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.vehicle_information_id;
													}
			},
												/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "vehicle_information",
					source_field: "vehicle_information_id",
					source_id: obj["vehicle_information_id"],
					user_id
				};
