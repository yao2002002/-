		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/registered_user/table','set') || $check_action('/registered_user/view','set') || $check_action('/registered_user/view','get') 
				...
				<template slot-scope="scope">
					...
					<el-button class="e-button el-button--small is-plain el-button--primary" style="margin: 5px !important;" size="small" @click="changeSigning(scope.row, scope.$index)" v-if="$check_option('/registered_user/table', 'examine')">
						<span>审核</span>
					</el-button>
				</div>
				</template>
