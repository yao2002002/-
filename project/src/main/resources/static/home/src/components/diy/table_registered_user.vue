    ...
    <el-form label-position="right" :model="query" class="form p_4" label-width="120">
      <el-row class="rows row1">
                      ...
                      <el-form-item label="联系方式">
                                                      <el-input v-model="query.contact_information"></el-input>
                                                </el-form-item>
                    </el-col>
                                                            <el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                        		  		  		  	...
                                        		  		  		  	<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="changeSigning(scope.row, scope.$index)" v-if="$check_option('/registered_user/table', 'examine')">
		  		<span>审核</span>
		  	</el-button>
		        </template>
    </el-table-column>
        ...
        this.showModal = false;
			...
			assureVerify() {
				...
				examineForm.validate((valid) => {
					if (valid) {
						var url = "~/api/registered_user/set?registered_user_id=" + this.verifyItem['registered_user_id']
						_this.$post(url, {
