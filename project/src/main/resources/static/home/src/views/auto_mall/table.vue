				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 汽车商城 -->
							<div><span>汽车商城</span></div>
							<table_auto_mall v-if="$check_action('/auto_mall/table','get')"></table_auto_mall>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_auto_mall from "../../components/diy/table_auto_mall.vue";
	export default {
		data() {
			return {
			};
