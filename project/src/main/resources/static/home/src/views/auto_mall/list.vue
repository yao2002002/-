<template>
	<div class="diy_list page_auto_mall" id="auto_mall_list">
		<div class="warp">
			<div class="container diy_list_container">
				<div class="diy_list_title">
					<div class="col">
						<span class="title">汽车商城列表</span>
					</div>
				</div>
				<div class="leis_box"> 
				<div class="iudis_box">
					...
					<div class="col">
						...
						<div class="view Search">
							<span class="diy_list_search_title">关键字搜索：</span>
																															<b-form-input size="sm" class="mr-sm-2" placeholder="汽车名称搜索" v-model="query['car_name']" />
...
<script>
	import list_auto_mall from "@/components/diy/list_auto_mall.vue";
