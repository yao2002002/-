	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/vehicle_reservation/table','del') || $check_action('/vehicle_reservation/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
				...
				<el-table-column prop="vehicle_no" @sort-change="$sortChange" label="车辆编号" 				v-if="$check_field('get','vehicle_no')" min-width="200">
					...
					<el-table-column prop="booking_quantity" @sort-change="$sortChange" label="预订数量" 				v-if="$check_field('get','booking_quantity')" min-width="200">
					</el-table-column>
					<el-table-column prop="reservation_remarks" @sort-change="$sortChange" label="预订备注" 				v-if="$check_field('get','reservation_remarks')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/vehicle_reservation/table','set') || $check_action('/vehicle_reservation/view','set') || $check_action('/vehicle_reservation/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/vehicle_reservation/table','set') || $check_action('/vehicle_reservation/view','set') || $check_action('/vehicle_reservation/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/vehicle_reservation/get_list?like=0",
				url_del: "~/api/vehicle_reservation/del?",
