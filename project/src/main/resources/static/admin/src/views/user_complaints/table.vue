<template>
	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/user_complaints/table','set') || $check_action('/user_complaints/view','set') || $check_action('/user_complaints/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					<el-button class="e-button el-button--small is-plain el-button--primary" style="margin: 5px !important;" size="small" @click="changeSigning(scope.row, scope.$index)" v-if="$check_option('/user_complaints/table', 'examine')">
						<span>审核</span>
					</el-button>
				</div>
				</template>
