	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/auto_mall/table','add') || $check_action('/auto_mall/view','add')" @click="$router.push('./view?')">添加</el-button>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/auto_mall/table','set') || $check_action('/auto_mall/view','set') || $check_action('/auto_mall/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					v-if="$check_action('/auto_mall/table','set') || $check_action('/auto_mall/view','set') || $check_action('/auto_mall/view','get')"
						...
						<router-link v-if="$check_comment('/auto_mall/table')" class="e-button e-button--small is-plain el-button--primary"
