	...
	<el-main class="bg edit_wrap comtable_e">
		...
		<el-row class="row_ce"> 
					...
					<div v-else-if="$check_field('get','delivery_time')">{{form['delivery_time']}}</div>
							...
							<el-form-item prop="delivery_location">
					<div slot="label">
						<i style="color: red;">*</i>
						交付地点
					</div>
					...
					<div v-else-if="$check_field('get','delivery_location')">{{form['delivery_location']}}</div>
							...
							<el-form-item prop="delivery_arrangements">
					<div slot="label">
						<i style="color: red;">*</i>
						交付安排
					</div>
	...
	export default {
			...
			return {
				...
				form: {
								"order_number": null, // 订单编号
										...
										"delivery_time":  '', // 交付时间
										"delivery_location": null, // 交付地点
										"delivery_arrangements": null, // 交付安排
		...
		methods: {
			...
			get_obj_after(json, func){
																														if(this.form["delivery_time"]=="0000-00-00 00:00:00"){
